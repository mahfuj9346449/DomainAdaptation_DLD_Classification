...
src_training = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'source_training.pkl')
src_validation = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'source_validation.pkl')
src_test = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'source_test.pkl')

tar_training = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'target_training.pkl')
tar_validation = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'target_validation.pkl')
tar_test = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'target_test.pkl')
