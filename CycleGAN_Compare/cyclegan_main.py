...
src_training = DA_init.loadPickle(cyclegan_utils.experimentalPath, src_name + '_training.pkl')
src_validation = DA_init.loadPickle(cyclegan_utils.experimentalPath, src_name + '_validation.pkl')
src_test = DA_init.loadPickle(cyclegan_utils.experimentalPath, src_name + '_test.pkl')

tar_training = DA_init.loadPickle(cyclegan_utils.experimentalPath, tar_name + '_' + src_name + '.pkl')
tar_test = DA_init.loadPickle(cyclegan_utils.experimentalPath, tar_name + '_test.pkl')

src_training = cyclegan_utils.normalizeInput(src_training, mode='Paired')
src_validation = cyclegan_utils.normalizeInput(src_validation, mode='Paired')
src_test = cyclegan_utils.normalizeInput(src_test, mode='Paired')

tar_training = cyclegan_utils.normalizeInput(tar_training, mode='Unpaired')
tar_test = cyclegan_utils.normalizeInput(tar_test, mode='Paired')
