...
if args.data_domain == 'Source':
    training = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'target_training.pkl')
    validation = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'target_validation.pkl')
    test = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'target_test.pkl')
...
if args.data_domain == 'Target':
    ...
    training = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'source_training.pkl')
    validation = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'source_validation.pkl')
    test = DA_init.loadPickle(FineTuning_utils.experimentalPath, 'source_test.pkl')
