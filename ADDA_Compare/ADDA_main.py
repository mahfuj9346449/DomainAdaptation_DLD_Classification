...
if args.step == 2:
    if args.data_domain == 'Source':
        reloadPath = '../checkpoint/ADDA_S2T_STEP1/ADDA_S2T_STEP1-183'
    elif args.data_domain == 'Target':
        reloadPath = '../checkpoint/ADDA_T2S_STEP1/ADDA_T2S_STEP1-22'
    else:
        reloadPath = ''
...
if args.step == 3:
    if args.data_domain == 'Source':
        reloadPath1 = '../checkpoint/ADDA_S2T_STEP1/ADDA_S2T_STEP1-183'
        reloadPath2 = '../checkpoint/ADDA_S2T_STEP2/ADDA_S2T_STEP2-15'
    elif args.data_domain == 'Target':
        reloadPath1 = '../checkpoint/ADDA_T2S_STEP1/ADDA_T2S_STEP1-22'
        reloadPath2 = '../checkpoint/ADDA_T2S_STEP2/ADDA_T2S_STEP2-178'
    else:
        reloadPath1 = ''
        reloadPath2 = ''

    reloadPath = [reloadPath1, reloadPath2]

    with tf.Session(config=config) as sess:
        res_model = DA_Model_step3(model_name=args.model_name,
                                   sess=sess,
                                   tst_data=[src_test, tar_test],
                                   epoch=args.epoch,
                                   restore_epoch=args.restore_epoch,
